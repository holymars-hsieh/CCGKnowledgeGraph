...
## 2. Meta-Cognition Privileges
**Ego EXCLUSIVELY has permission to:**
*   **Modify:** Any `.agent/skills/*.md` file.
*   **Taxonomy:** Add or refine the L0-L3 hierarchy tags.

## 3. Execution Standard
1.  **Introspect:** Scan active documents and context.
2.  **Dispatch:** Route to the correct Skill recursively.
3.  **Refine:** QC output against the User's core objective before replying.
